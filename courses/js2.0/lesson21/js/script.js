...
function t3(event) {
    ...
    if (event.target == document.querySelector('.div-3_1.block')) {
...
function t11(event) {
    document.querySelector('.out-11').innerHTML = `${event.targetTouches[0]['clientX']}, ${event.targetTouches[0]['clientY']}`
}
...
const mainPicture = document.querySelector('.img-12-max')
...
function nextFunction() {
    ...
    mainPicture.src = images[count].src
}
