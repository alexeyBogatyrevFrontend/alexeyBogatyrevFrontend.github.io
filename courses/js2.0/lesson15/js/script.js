...
// console.log(a);
// console.log(a[0]); // no особенности сетов
// console.log(a.length); // no
// console.log(a.size); // show the count of elements
// // check has or not
// console.log(a.has(2)); // true or false
// console.log(a.has('2')); // true or false
...
const f7 = () => {
    ...
    let text = new Set(input)
    let arr = Array.from(text)


    if (text && (arr.length > 6)) {
