...
function t3() {
    let out = a3.map(function (elem) {
        return a3_res.push(+elem)
    })
...
function t4() {
    a4.map(function (elem) {
        if (typeof elem == 'number') {
            return a4_res.push(elem)
        }
    })
...
function t9() {
    b9.filter((elem) => {
        if (typeof elem == 'number') {
            return b9_num.push(elem)
        } else {
            return b9_string.push(elem)
        }
    })
