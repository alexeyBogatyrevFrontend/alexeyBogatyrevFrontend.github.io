...
// first assigns to last and vice versa
let a = [1, 2, 3, 4]
console.log(a);
let t = a[0]
a[0] = a[a.length - 1]
...
let ar1 = ['hello', 5, true, 'world', 26, false] // переменную обьявляем здесь!!!!
...
let ar2 = ['hello', 5, true, 'world', 26, false] // переменную обьявляем здесь!!!!
...
let ar3 = [1, 2, 3, true, false, '123', 'hello', 5283] // переменную обьявляем здесь!!!!
...
let ar4 = [1, true, '3', true, false, 6, 7, 8, 239, 10] // переменную обьявляем эту здесь!!!!
...
let ar6 = ['alexey', 'sagittarius', 11, 12]
...
function f10() {
    ...
    document.querySelector('.out-10').innerHTML = `${ar10[0]}, ${ar10[lastIndex]}`
}
