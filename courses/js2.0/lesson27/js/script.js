...
function t6() {
    let a = new Promise((resolve, reject) => {
        fetch('http://getpost.itgid.info/index2.php', {
            ...
            body: 'auth=7859d9d42a8834141d529577207c9596&action=3&num1=5&num2=17'
        })
            .then(data => {
                resolve(data.text())
            })
    ...
    let b = new Promise((resolve, reject) => {
        fetch('http://getpost.itgid.info/index2.php', {
            ...
            body: 'auth=7859d9d42a8834141d529577207c9596&action=4&num1=53&nume2=62'
        })
            .then(data => {
                resolve(data.text())
            })
...
function t7() {
    ...
    let b = new Promise((resolve, reject) => {
        fetch('http://getpost.itgid.info/index2.php', {
            ...
            body: 'auth=7859d9d42a8834141d529577207c9596&action=6&num1=53&num2=62'
        })
            .then(data => {
                resolve(data.text())
            })
