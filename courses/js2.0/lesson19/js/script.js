...
function t2() {
    if (event.altKey == true) {
        document.querySelector('.out-2').innerText = true

    } else {
        document.querySelector('.out-2').innerText = false
...
function t5() {
    ...
    console.log(document.querySelector('.div-5').classList.contains('active'));
}
